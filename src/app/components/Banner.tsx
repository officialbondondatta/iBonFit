        ...
        <section className="p-5 lg:p-0">
            <div className="bg-linear-to-r grid grid-cols-1 lg:grid-cols-2 items-center justify-center lg:gap-2 gap-10 from-lime-200 via-lime-100 to-indigo-100  container mx-auto my-5 p-10 rounded-2xl" >
                <div className="flex flex-col lg:text-left text-center pl-5 justify-center text-slate-500  space-y-4">
                    ...
                    <button className="lg:self-start self-center  bg-lime-300 text-slate-900 font-semibold px-3 py-2 border border-white rounded-md cursor-pointer">BROWSE WORKOUTS</button>
                </div>
